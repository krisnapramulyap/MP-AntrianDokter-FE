    ...
    return (
        <>
                    ...
                    <div className="why-text">
                        <div className="row">
                            <div className="col-4 ps-1">
                                <div className="card">
                                    <div className="card-body">
                                        <img className='photo1' alt="" src={card1} width="280px" height="220px" />
                                        <p style={{ marginTop: '40px' }} >Pilih Dokter untuk<br></br> Kunjungan Kamu</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-4 ps-4">
                                <div className="card">
                                    <div className="card-body">
                                        <img className='photo2' alt="" src={card2} width="280px" height="260px" />
                            ...
                            <div className="col-4 ps-5">
                                <div className="card">
                                    <div className="card-body">
                                        <img className='photo3' alt="" src={card3} width="280px" height="230px" />
                                        <p style={{ marginTop: '40px' }}>Datang sesuai Tanggal dan<br></br>
                                            Jam yang sudah Ditentukan</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="row">
                    ...
                    <div className="col-sm ">
                        <div className='grid2'>
                            ...
                            <p>Dengan MediQ kamu udah tau duluan
                                Nomor Antrian Kamu dan Jam berapa<br></br>
                                waktu kunjungan kamu. Dengan begitu
                                kamu ga repot harus nungguin Dokter<br></br>
                                dari pagi</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="col-sm ">
                        <div className='grid3'>
                            ...
                            <p>Bapak/Ibu Dokter yang ada di MediQ, <br></br>adalah dokter pilihan bestie! Semuanya sudah pasti memiliki pengalaman di <br></br>Polinya selama Bertahun-tahun. Jadi<br></br> kamu ga perlu ragu buat Konsultasi<br></br> Dokter lewat MediQ </p>
                        </div>
                    </div>
                    <div className="col-sm grid-service grid-best">
            ...
            <div className="download">
                <img alt="" src={download} className="" />
            </div>
        </>
    );
};